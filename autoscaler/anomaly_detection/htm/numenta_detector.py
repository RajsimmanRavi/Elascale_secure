...
class NumentaDetector():
  ...
  def __init__(self, inputMin, inputMax, prob_index):
    ...
    self.probationaryPeriod = prob_index
  ...
  def handleRecord(self, inputValue, inputTimestamp):
    ...
    if self.useLikelihood:
      ...
      anomalyScore = self.anomalyLikelihood.anomalyProbability(
        inputValue, rawScore, inputTimestamp)
