...
# RAJ: MAKE SURE THIS IS IN RYU CONTROLLER: /usr/local/lib/python2.7/dist-packages/ryu/topology/switches.py
# I made a change to include IP address of switch when calling /switches REST call (SEE Line number 128)
...
class Switch(object):
    ...
    def to_dict(self):
        d = {'dpid': dpid_to_str(self.dp.id),
             ...
             'ip': self.dp.socket.getpeername()[0]}
        return d
